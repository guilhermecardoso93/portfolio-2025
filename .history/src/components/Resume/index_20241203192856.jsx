            ...
            <div className="resume-list">
              <div className="resume-item">
                ...
                <p>
                  ...
                  <span>
                    Realizo a conferência e validação de notas fiscais
                    eletrônicas (NF-e) para assegurar o correto registro das
                    transações.
                  </span>

                  <span>
                    <strong>Contas a Pagar</strong>: Gerencio o processo de contas a pagar, desde
                    a conferência das notas fiscais até o agendamento de
                    pagamentos, respeitando os prazos estabelecidos. Recebimento
                    de Mercadorias Responsável pela conferência de mercadorias,
                    garantindo que os produtos recebidos atendam às
                    especificações e quantidades descritas nos pedidos de
                    compra. Faço a interface com o departamento de compras e
                    estoque e corrijo divergências entre notas fiscais e
                    mercadorias.
                  </span>
                  <span>
                    Departamento Pessoal (Tarefas Básicas) Atuo na administração
                    de processos de admissão e demissão de funcionários,
                    controle de ponto eletrônico, atualização de cadastros e
                    organização de documentação trabalhista, incluindo folha de
                    pagamento, férias e décimo terceiro
                  </span>
                </p>
              </div>
              <div className="resume-item">
