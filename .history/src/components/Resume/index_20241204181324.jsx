      ...
      <div className="resume-container">
        ...
        <div className="resume-box">
          ...
          >
            ...
            <div className="resume-list jobs">
          ...
          >
            ...
            <div className="resume-list hab">
              ...
              <div className="habilidades">
                ...
                <p className="company">
                  Falo Inglês, fiz curso de 5 Anos. Tenho Certificado Cambridge.
                  Quero Muito aprender Coreano.
                </p>{" "}
              </div>
            </div>
          </div>
              ...
              <div>
                <div className="resume-item">
                  ...
                  <div className="fatos">
                    ...
                    <span>Jogo League of Legends - Menos de ADC </span>
                    <span>Amo Overwatch, X-men e Digimon </span>
                    <span>Tenho 11 Tatuagens</span>
                    <span>Já fui voluntário na Primeira CCXP 2014 </span>
                    <span>
                      Tento participar dos eventos de Programação como NLW -
                      Alura
                    </span>
                  </div>
                </div>
