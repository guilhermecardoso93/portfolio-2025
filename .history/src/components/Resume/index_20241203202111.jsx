        ...
        <div className="resume-box">
          ...
          >
            ...
            <div className="resume-list">
              ...
              <div>
                <div className="resume-item fatos">
                  <p> Algumas Fatos Legais:</p>
                  <div>
                    {" "}
                    <p>Tenho dos Gatos : NingNing & Kook </p>
                    <p>Tenho um irmão gêmeo </p>
                    <p>Jogo League of Legends - Menos de ADC </p>
                    <p>Amo Overwatch, X-men e Digimon </p>
                    <p>Tenho 11 Tatuagens</p>
                    <p>Já fui voluntário na Primeira CCXP 2014 </p>
                  </div>
                </div>
              </div>
            </div>
